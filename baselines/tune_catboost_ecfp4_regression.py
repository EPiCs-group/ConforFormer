#!/usr/bin/env python3
"""ECFP4_1024 CatBoost hyperparameter tuning + 5-seed repeat evaluation on regression tasks."""
...
from baselines.catboost_ecfp_baseline import run_task
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--output-root",
        type=Path,
        default=Path("results/ecfp4_catboost_regression_tuning"),
    )
...
def get_config_space() -> list[dict[str, float | int | str]]:
    return [
        {"config_id": "c01", "iterations": 300, "depth": 4, "learning_rate": 0.08, "l2_leaf_reg": 3.0, "random_strength": 1.0, "bagging_temperature": 0.0},
        {"config_id": "c02", "iterations": 500, "depth": 4, "learning_rate": 0.05, "l2_leaf_reg": 3.0, "random_strength": 1.0, "bagging_temperature": 0.0},
        {"config_id": "c03", "iterations": 500, "depth": 6, "learning_rate": 0.05, "l2_leaf_reg": 3.0, "random_strength": 1.0, "bagging_temperature": 0.0},
        {"config_id": "c04", "iterations": 700, "depth": 6, "learning_rate": 0.04, "l2_leaf_reg": 4.0, "random_strength": 1.0, "bagging_temperature": 0.0},
        {"config_id": "c05", "iterations": 900, "depth": 6, "learning_rate": 0.03, "l2_leaf_reg": 5.0, "random_strength": 1.0, "bagging_temperature": 0.0},
        {"config_id": "c06", "iterations": 700, "depth": 8, "learning_rate": 0.04, "l2_leaf_reg": 5.0, "random_strength": 1.0, "bagging_temperature": 0.0},
        {"config_id": "c07", "iterations": 900, "depth": 8, "learning_rate": 0.03, "l2_leaf_reg": 6.0, "random_strength": 1.0, "bagging_temperature": 0.0},
        {"config_id": "c08", "iterations": 500, "depth": 6, "learning_rate": 0.05, "l2_leaf_reg": 4.0, "random_strength": 2.0, "bagging_temperature": 0.5},
        {"config_id": "c09", "iterations": 700, "depth": 6, "learning_rate": 0.04, "l2_leaf_reg": 5.0, "random_strength": 2.0, "bagging_temperature": 1.0},
        {"config_id": "c10", "iterations": 900, "depth": 8, "learning_rate": 0.03, "l2_leaf_reg": 6.0, "random_strength": 2.0, "bagging_temperature": 1.0},
    ]
...
def run_config(
    ...
    print(
        "[cfg] "
        f"iter={args.iterations} depth={args.depth} lr={args.learning_rate} "
        f"l2={args.l2_leaf_reg} random_strength={args.random_strength} "
        f"bagging_temperature={args.bagging_temperature}",
        flush=True,
    )
