#!/usr/bin/env python3
"""ECFP4_1024 CatBoost hyperparameter tuning + 5-seed repeat evaluation on classification tasks."""
...
from baselines.tune_catboost_ecfp4_regression import get_config_space
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--output-root",
        type=Path,
        default=Path("results/ecfp4_catboost_classification_tuning"),
    )
